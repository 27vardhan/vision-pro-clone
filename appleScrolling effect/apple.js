...
const locoScroll = new LocomotiveScroll({
  el: document.querySelector("#mainApple"),
  smooth: true
});
// each time Locomotive Scroll updates, tell ScrollTrigger to update too (sync positioning)
locoScroll.on("scroll", ScrollTrigger.update);

// tell ScrollTrigger to use these proxy methods for the "#mainApple" element since Locomotive Scroll is hijacking things
ScrollTrigger.scrollerProxy("#mainApple", {
  scrollTop(value) {
  ...
  pinType: document.querySelector("#mainApple").style.transform ? "transform" : "fixed"
});
...
//first page js starts
loco()

gsap.to("#pageApple>video",{
    scrollTrigger:{
        trigger:'#pageApple>video',
        start:'1% top',   // 1% shows on scrolling 1% from top video should start 
        end:'bottom top',
        // markers:true,  // markers basically shows the start text and end of page till where the scrolling is going
        scroller:'#mainApple'

    },

    onStart:()=>{
        document.querySelector("#pageApple>video").play()
    }
})
...
//timeline to move text upwards in site
t1.to("#page1>h1",{
  top:'-50%'
})
...
function files(index) {
var data = `.//vr canvas img/Vision00001.png
.//vr canvas img/Vision00002.png
/vr canvas img/Vision00003.png
/vr canvas img/Vision00004.png
/vr canvas img/Vision00005.png
/vr canvas img/Vision00006.png
/vr canvas img/Vision00007.png
/vr canvas img/Vision00008.png
/vr canvas img/Vision00009.png
/vr canvas img/Vision00010.png
/vr canvas img/Vision00011.png
/vr canvas img/Vision00012.png
/vr canvas img/Vision00013.png
/vr canvas img/Vision00014.png
/vr canvas img/Vision00015.png
/vr canvas img/Vision00016.png
/vr canvas img/Vision00017.png
/vr canvas img/Vision00018.png
/vr canvas img/Vision00019.png
/vr canvas img/Vision00020.png
/vr canvas img/Vision00021.png
/vr canvas img/Vision00022.png
/vr canvas img/Vision00023.png
/vr canvas img/Vision00024.png
/vr canvas img/Vision00025.png
`
;
return data.split("\n")[index];
}
